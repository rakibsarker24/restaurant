        ...
        <div>
            ...
            <div class="bg-gray-200 rounded py-16 px-12 m-16 flex flex-col items-center justify-center">
                ...
                <form method="post" class="mt-8 mb-4">
                    ...
                    <input class="border-solid border border-gray-400 rounded px-2 py-3 w-full" type="email" id="userEmail" placeholder="Email address" required />
                    </div>
                    <div>
                    <label for="userEmail" class="sr-only">Password</label>
                    <input class="border-solid border border-gray-400 rounded px-2 py-3 w-full" type="password" id="userPass" placeholder="Password" required />
                    </div>
                    ...
                    <p className='text-body'>Have you already an Account?<Link to='/login' className='text-subbrand'> Login</Link></p>
                </form>
